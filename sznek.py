...
fac_img = pygame.transform.scale(fac_img, (23, 23))
blank_img = pygame.image.load('koc.png')
blank_img = pygame.transform.scale(blank_img, (23, 23))
...
def show_splash_screen(window):
    ...
    splash_image = pygame.transform.scale(splash_image, (1200, 1200))
